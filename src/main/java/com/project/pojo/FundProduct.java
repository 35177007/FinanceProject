...
public class FundProduct {
    ...
    public FundProduct(Integer id, Integer type, Integer code, String fundDesc, BigDecimal dailyGrowth, BigDecimal monthlyGrowth, BigDecimal annualGrowth, BigDecimal leastMoney, String invesTerm) {
        this.id = id;
        this.type = type;
        this.code = code;
